...
5.  Below are the components of a Quarto (`.qmd`) file:
...
Unemployed_individuals <- (0.2*330)*Unemployment_Rate
Unemployed_individuals
```
...
**Sample correlation:** $$r=\frac{1}{n-1}^n(\frac{x-\overline{x}}{s_x})(\frac{y-\overline{y}}{s_y})$$
...
write_csv(cps,"C:/Users/admin/ECON2250_Labs_Parchuri_Eshika/cps.csv")
```
